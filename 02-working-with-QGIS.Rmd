...
You can create, load, save and 'save as' projects using the buttons shown in Figure \@ref(fig:project_buttons) or using the options in the Project menu.


```{r project_buttons, fig.cap="New Project, Open Project, Save Project, Save Project As buttons", out.width="50%"}
...
* 4326 - the World Geodetic System 1984 which is a widely used  geographical coordinate system
