...
```{r imported, fig.cap="The map after the file 'leeds_lsoa.shp' has been imported.", echo=FALSE}
knitr::include_graphics("figures/imported.png")
```
...
```{r layers, fig.cap="The imported data layers shown in the Layer window.", out.width="50%", echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/ITSLeeds/QGIS-intro/master/figures/layers.png")
```
