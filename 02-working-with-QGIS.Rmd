...
```{r projectsetup, fig.cap="Project menu, project properties, set Coordinate ReferenceSystsm 27700", out.width="50%"}
knitr::include_graphics("figures/setProjection.JPG")
```

Type 27700 into the Filter box. 27700 refers to the "OSGB 1936 British National Grid". This is a projected coordinate system for the UK.  (there is a brief explanation of co-ordinate systems in chapter 2)
