...
If the map appears to be 'squashed', distorted and compressed in the vertical (North-South) dimension, this is probably because the coordinate system needs to be set, to 27700. See Section \@ref(projections-and-coordinate systems) for details.
```
